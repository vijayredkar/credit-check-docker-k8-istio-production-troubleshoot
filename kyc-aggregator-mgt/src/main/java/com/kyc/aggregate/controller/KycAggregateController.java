...
public class KycAggregateController {
	...
	ObjectMapper mapper;
		...
		public ResponseEntity<String> getKyc(@RequestParam(required = false, name = "type") String type ,
											...
											//@RequestParam(required = false, name = "kafkaTopicName") String kafkaTopicName, 
											@RequestParam(required = false, name = "mongoFirstName") String mongoFirstName ) 
											throws JsonProcessingException
		{
			KycResponse kycResponse = null;
					
			LOGGER.info("\n----****## Kyc Aggrregator Mgt initiated with type : " + type);
			LOGGER.info("\n----****## Kyc Aggrregator Mgt initiated with headerValue : " + headerValue);
			LOGGER.info("\n----****## Kyc Aggrregator Mgt initiated with creditCheck : " + creditCheck);
			//LOGGER.info("\n----****## Kyc Aggrregator Mgt initiated with kafkaTopicName : " + kafkaTopicName);
			LOGGER.info("\n----****## Kyc Aggrregator Mgt initiated with mongoFirstName : " + mongoFirstName);
			...
			{		
				...
				kycResponse = kycAggrSvc.processKyc(type, headerValue, creditCheck, mongoFirstName );
			}
